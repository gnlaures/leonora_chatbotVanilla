...
const cFormFeedbacks = '' +
    '<div class="c-formFeedback">' +
        '<div class="c-formFeedback__content u-dnone --success">' +
            '<i>' +
                '<img src="https://b2bleonorashop.vteximg.com.br/arquivos/cChatbot_icon_success.png" alt="Formulário enviado com sucesso!">' +
            '</i>' +
...
' title="Voltar"><span>Voltar</span></a></p>' +
        ...
        '<div class="c-formFeedback__content u-dnone --error">' +
            '<i>' +
                '<img src="https://b2bleonorashop.vteximg.com.br/arquivos/cChatbot_icon_error.png" alt="Formulário não enviado, tente novamente mais tarde.">' +
            '</i>' +
        ...
        '<div class="c-formFeedback__content u-dnone --load">' +
            '<i>' +
                '<img src="https://b2bleonorashop.vteximg.com.br/arquivos/cChatbot_icon_load.png" alt="Enviando" class="css-animation-load">' +
            '</i>' +
            '<p>Enviando</p>' +
        '</div>' +
    '</div>';